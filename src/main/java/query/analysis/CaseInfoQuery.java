...
public class CaseInfoQuery extends AnalysisQuery {
    ...
    public String getQuery() {
        ...
        return String.format(
                ...
                + "select caseId, count(activity) as number_of_activities, count(resource) as number_of_resources, (extract(epoch from min(time_stamp)) -  extract(epoch from max(time_stamp)))/60 as duration from %s as t group by caseId"
